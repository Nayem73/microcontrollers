...
;MyProject.c,7 :: 		portb.f1 = 0;
	BCF        PORTB+0, 1
;MyProject.c,11 :: 		PWM1_Init(1000);
	BSF        T2CON+0, 0
	BSF        T2CON+0, 1
	MOVLW      124
	MOVWF      PR2+0
	CALL       _PWM1_Init+0
;MyProject.c,12 :: 		PWM1_Start();
	CALL       _PWM1_Start+0
;MyProject.c,13 :: 		PWM1_Set_Duty(duty);
...
L_main5:
	...
	GOTO       L_main5
	NOP
;MyProject.c,18 :: 		if (portd.f0 == 1 && duty < 250) {
	BTFSS      PORTD+0, 0
	GOTO       L_main8
	MOVLW      128
	BTFSC      main_duty_L0+0, 7
...
L__main23:
	...
	GOTO       L_main8
L__main19:
;MyProject.c,19 :: 		duty += 10;
	MOVLW      10
	ADDWF      main_duty_L0+0, 0
	MOVWF      R0+0
	MOVF       R0+0, 0
	MOVWF      main_duty_L0+0
;MyProject.c,20 :: 		PWM1_Set_Duty(duty);
	MOVF       R0+0, 0
	MOVWF      FARG_PWM1_Set_Duty_new_duty+0
	CALL       _PWM1_Set_Duty+0
;MyProject.c,21 :: 		}
...
;MyProject.c,22 :: 		}
L_main4:
;MyProject.c,23 :: 		if (portd.f1 == 1 && duty > 0) {
	BTFSS      PORTD+0, 1
	GOTO       L_main11
	MOVLW      128
	XORLW      0
...
L_main12:
	...
	GOTO       L_main12
	NOP
;MyProject.c,25 :: 		if (portd.f1 == 1 && duty > 0) {
	BTFSS      PORTD+0, 1
	GOTO       L_main15
	MOVLW      128
	XORLW      0
	...
	GOTO       L_main15
L__main17:
;MyProject.c,26 :: 		duty -= 10;
	MOVLW      10
	SUBWF      main_duty_L0+0, 0
	MOVWF      R0+0
	MOVF       R0+0, 0
	MOVWF      main_duty_L0+0
;MyProject.c,27 :: 		PWM1_Set_Duty(duty);
	MOVF       R0+0, 0
	MOVWF      FARG_PWM1_Set_Duty_new_duty+0
	CALL       _PWM1_Set_Duty+0
;MyProject.c,28 :: 		}
